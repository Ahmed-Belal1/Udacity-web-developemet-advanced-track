...
Samlpe:`curl http://127.0.0.1:5000/questions?page=1`
```
{
  "categories": [
    "Science",
...
deletes a certain question using it's id
 ...
 Sample:`curl -X DELETE http://127.0.0.1:5000/questions/11`
 ```
{
  "deleted": 11,
  "success": true
...
Sample:`curl -X POST -H "Content-Type: application/json" -d '{"question":"Where are the pyramids?", "answer":"egypt","category":1,"difficulty":4}' http://127.0.0.1:5000/questions`
```
{
    "created":25
    "success":true
...
response sample:`curl http://127.0.0.1:5000/categories/4/questions`
```
{
